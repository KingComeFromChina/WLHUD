...
private let WLIdentifier = "WLScreenView"
...
public class WLProgressHUD: UIView {
    ...
    init(text: String?,type: WLHUDType,delay: TimeInterval) {
    ...
    private func config(){
        ...
        switch type {
        case .success:
            addImageView(image: WLHUDImage.imageOfSuccess)
            
        case .error:
            addImageView(image: WLHUDImage.imageOfError)
            
        case .info:
            addImageView(image: WLHUDImage.imageOfInfo)
    ...
    private func size(from text: String) -> CGSize {
        ...
        return text.textSizeWithFont(font: textFont,
                                     constrainedToSize: CGSize(width: selfWidth - padding,
    ...
    private func generalConstraint(at view: UIView){
        ...
        if let _ = text {
            ...
            addConstraint(with: view,
                          ...
                          bottomView: nil,
                          rightView: nil,
                          edgeInset: UIEdgeInsets(top: padding,
                                                  left: 0,
                                                  bottom: 0,
                                                  right: 0))
        }else {
    ...
    public static func showSuccess(text: String?, delay: TimeInterval) {
        ...
        WLProgressHUD(text: text, type: .success, delay: delay).show()
    }
    
    public static func showError(text: String?, delay: TimeInterval) {
    
        WLProgressHUD(text: text, type: .error, delay: delay).show()
    }
    
    public static func showLoading(){
    
        WLProgressHUD(text: nil, type: .loading, delay: 0).show()
    }
    
    public static func showLoading(text: String?){
    
        WLProgressHUD(text: text, type: .loading, delay: 0).show()
    }
    
    public static func showInfo(text: String?, delay: TimeInterval) {
    
        WLProgressHUD(text: text, type: .info, delay: delay).show()
    }
    
    public static func showText(text: String?, delay:TimeInterval) {
    
        WLProgressHUD(text: text, type: .text, delay: delay).show()
    }
    ...
    public func show(){
        ...
        self.animate(hide: false){
            ...
            if self.delay > 0{
                ...
                WLProgressHUD.asyncAfter(duration: self.delay, completion: {
    ...
    public func hide(delay: TimeInterval = delayTime) {
        ...
        WLProgressHUD.asyncAfter(duration: delay){
    ...
    public static func hide(){
        ...
        for view in keyWindow.subviews {
            ...
            if view.restorationIdentifier == WLIdentifier {
                view.removeFromSuperview()
            }
        }
    }
    ...
    private lazy var screenView : UIView = {
        ...
        $0.restorationIdentifier    = WLIdentifier
...
// MARK: Class WLHUDImage

private class WLHUDImage {
    ...
    fileprivate class func draw(_ type: WLHUDType){
    ...
    fileprivate static var imageOfError : UIImage {
        ...
        guard HUD.imageOfError == nil else {
    ...
    fileprivate static var imageOfInfo : UIImage {
        ...
        guard HUD.imageOfInfo == nil else {
    ...
    fileprivate func addConstraint(width: CGFloat,height: CGFloat){
        ...
        if width > 0 {
            addConstraint(NSLayoutConstraint(item: self,
                                             ...
                                             relatedBy: .equal,
                                             toItem: nil,
                                             attribute: NSLayoutAttribute(rawValue: 0)!,multiplier: 1,
                                             constant: width))
        }
